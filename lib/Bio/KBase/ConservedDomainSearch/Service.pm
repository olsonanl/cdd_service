package Bio::KBase::ConservedDomainSearch::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::ConservedDomainSearch::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service ConservedDomainSearch does not require authentication.
	...
	my $stderr = Bio::KBase::ConservedDomainSearch::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service ConservedDomainSearch.");
    }
...
package Bio::KBase::ConservedDomainSearch::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::ConservedDomainSearch::ServiceContext
...
package Bio::KBase::ConservedDomainSearch::ServiceStderrWrapper;
